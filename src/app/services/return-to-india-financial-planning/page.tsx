...
const ourServices = [
  {
    title: "RNOR & Residency Planning",
    description: "Optimize your RNOR status for maximum tax benefits during your transition to India",
    details: [
      "Strategic return timing and residency forecasting",
      "Split-stay guidance for India + foreign countries",
      "PAN, Aadhaar, and compliance onboarding"
    ]
  },
  {
    title: "Tax Planning & Compliance",
    description: "Double taxation relief with DTAA and Form 67 for seamless cross-border tax management",
    details: [
      "Foreign tax credit optimization",
      "Global asset reporting and compliance",
      "Treaty interpretation for edge cases"
    ]
  },
  {
    ...
    details: [
      "Section 54/54F exemptions on property sales",
      "FEMA compliance for real estate transactions",
      "Property investment optimization"
    ]
  },
  {
    title: "Investment & Portfolio Management",
    description: "Tax-efficient investment strategies and global portfolio optimization",
    details: [
      "RSU/ESPP vesting for tax efficiency",
      "Global brokerage and retirement exits",
      "Retirement planning across borders"
    ]
  },
  {
    title: "Business & Hiring Structures",
    description: "Set up business in India with offshore compliance and hiring structures",
    details: [
      "Cross-border business tax optimization",
      "Hiring structures for global talent",
...
const processSteps = [
  ...
  { step: "02", title: "Connect with Expert", description: "Get matched with qualified CA/CPA/CFA via Zoom or phone call" },
...
const benefits = [
  {
    ...
    description: "Connect instantly through Zoom calls or high-quality phone calls with qualified CA, CPA, CFA, and Property Lawyers"
  },
  {
...
const generalFAQs = [
  ...
  },
  {
    ...
    answer: "Our clients typically save ₹15-30L in taxes during their transition to India through proper RNOR planning, DTAA optimization, and strategic timing. The ROI on our consultation is usually 1000%+."
  },
  {
...
const serviceCategories = [
  {
    ...
    title: 'RNOR & Residency Planning',
    content: {
      title: 'Strategic RNOR Planning for Maximum Tax Benefits',
      description: 'We help you optimize your RNOR status and residency timing to minimize tax liability during your transition to India.',
      features: [
        'Strategic return timing for maximum RNOR benefits',
        'DTAA optimization and Form 67 guidance',
        'Foreign tax credit maximization',
        'Split-stay guidance for India + foreign countries',
        'Residency forecasting and planning'
      ]
    }
  },
  {
    ...
    content: {
      title: 'Comprehensive Asset Optimization Strategy',
      description: 'Maximize your wealth through strategic asset management and investment planning during your return to India.',
      features: [
        'RSU/ESPP vesting optimization',
        'Retirement account strategy (401k, IRA, etc.)',
        'Property sale timing and exemptions',
  ...
  },
  {
    ...
    content: {
      title: 'Advanced Tax Planning and Compliance',
      description: 'Minimize your tax burden through expert tax strategy and ensure full compliance with Indian tax laws.',
      features: [
        'Capital gains tax optimization',
        'DTAA treaty benefits maximization',
        'TDS refund assistance',
        'Tax-efficient remittance strategies',
  ...
  },
  {
    ...
    title: 'Property & Real Estate Planning',
    content: {
      title: 'Property Sale & Investment Strategy for Return to India',
      description: 'Optimize your property transactions and real estate investments as you transition back to India.',
      features: [
        'Timing your property sale for maximum RNOR benefits',
        'Capital gains exemption planning (Section 54, 54F)',
        'Property investment strategy for returning NRIs',
        'Real estate documentation for tax compliance',
        'Rental income optimization during transition'
      ]
    }
  },
  {
    id: 'money-movement',
    title: 'Money Movement & Banking',
    content: {
      title: 'Banking and Money Transfer Strategy',
      description: 'Set up your banking structure and optimize money transfers as you return to India.',
      features: [
        'Bank account setup (NRE, NRO, FCNR) for returnees',
        'LRS optimization for ongoing transfers',
        'Foreign investment repatriation strategies',
        'Currency conversion timing and hedging',
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">
                We Plan Your Return to India
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                Get a complete roadmap for your financial transition with tax optimization and retirement planning from qualified cross-border experts.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-foreground">Save ₹15-30L in taxes during your return</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-foreground">Optimize your RNOR status for maximum benefits</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-foreground">Complete financial transition roadmap</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                ...
                <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium">CPA</span>
                <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium">Property Lawyer</span>
                <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium">CFA</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-muted-foreground">500+ successful transitions</span>
              </div>
            </div>
        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">What&apos;s Included in Your Comprehensive Planning</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Your complete return to India roadmap with expert guidance, tax optimization, and ongoing support.
              </p>
            </div>
      ...
      <Section id="consultation-booking" className="py-16 lg:py-20 bg-background">
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">How We Plan Your Return</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Simple 4-step process to get your complete return to India financial roadmap.
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-muted-foreground leading-relaxed">Provide your tax situation and specific questions</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Why choose us for your cross-border financial planning needs
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-border/20">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Your financial information is protected with bank-level security. All consultations are completely confidential.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about our return to India planning services
              </p>
            </div>
