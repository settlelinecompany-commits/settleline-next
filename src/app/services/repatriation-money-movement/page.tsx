...
const processSteps = [
  ...
  { step: "02", title: "Connect with Expert", description: "Get matched with qualified CA/CPA/FEMA Expert via Zoom or phone call" },
...
const benefits = [
  {
    ...
    description: "Connect instantly through Zoom calls or high-quality phone calls with qualified CA, CPA, and FEMA experts"
  },
  {
...
const generalFAQs = [
  {
    ...
    answer: "Start with our 30-minute risk-free intro call. During this call, we'll assess your repatriation needs and determine exactly how many sessions you'll need for complete planning. We can only provide this guidance after understanding your specific circumstances."
  },
  {
    question: "How much can I save with proper repatriation planning?",
    answer: "Our clients typically save ₹2-10L in penalties and fees through proper FEMA compliance, optimal transfer timing, and bank coordination. The ROI on our consultation is usually 1000%+."
  },
  {
...
const serviceCategories = [
  {
    id: 'property-repatriation',
    title: 'Property Sale & Rental Repatriation',
    content: {
      title: 'Strategic Property Repatriation',
      description: 'We help you structure property sale and rental transfers abroad with full FEMA compliance.',
      features: [
        'Form 15CA/CB preparation and filing',
        'DTAA application for rental/sale income',
        'Bank coordination and documentation',
        'Multi-year transfer planning',
        'Penalty-free execution strategies'
      ]
    }
  },
  {
    id: 'inheritance-gifts',
    title: 'Inheritance & Gift Transfers',
    content: {
      title: 'Cross-Border Inheritance Planning',
      description: 'Repatriate inherited assets and gifts with proper FEMA/RBI compliance and documentation.',
      features: [
        'FEMA/RBI rules for cross-border gifts',
        'Inheritance documentation and clearance',
        'Family transfer structuring',
  ...
  },
  {
    ...
    title: '$1M Desk & RBI Approvals',
    content: {
      title: 'Large Amount Repatriation',
      description: 'Navigate the $1M annual cap and RBI approval processes for larger transfers.',
      features: [
        '$1M annual repatriation cap optimization',
        'RBI approval workflows and documentation',
        'Multi-year transfer structuring',
        'Bank escalation handling',
  ...
  },
  {
    ...
    title: 'Form 15CA/CB & Bank Coordination',
    content: {
      title: 'Banking and Documentation Support',
      description: 'Get Chartered Accountant certification and bank coordination for smooth transfers.',
      features: [
        'Chartered Accountant certification',
        'Purpose codes and documentation',
        'Bank escalation resolution',
...
export default function RepatriationMoneyMovementPage() {
  ...
  const [activeServiceCategory, setActiveServiceCategory] = useState('property-repatriation');
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">
                We Move Your Money Safely
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                Repatriate funds across borders legally and efficiently with expert guidance from qualified cross-border specialists.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-foreground">Save ₹2-10L in penalties and fees</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-foreground">100% FEMA-compliant transfers</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-foreground">Complete bank coordination and documentation</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                ...
                <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium">Banking Specialist</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-muted-foreground">300+ successful transfers</span>
              </div>
            </div>
        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">What&apos;s Included in Your Repatriation Planning</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Your complete money transfer roadmap with expert guidance, FEMA compliance, and ongoing support.
              </p>
            </div>
      ...
      <Section id="consultation-booking" className="py-16 lg:py-20 bg-background">
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">How We Move Your Money Safely</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Simple 4-step process to get your complete repatriation and money transfer roadmap.
              </p>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-muted-foreground leading-relaxed">Provide your transfer needs and specific questions</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
              ...
              <div className="bg-muted/20 rounded-lg p-8 border border-border/30 shadow-sm">
                ...
                {/* Service Type */}
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-lg font-semibold text-foreground">Repatriation & Money Movement</div>
                  </div>
                  </div>
                ...
                onClick={() => {
                  const params = new URLSearchParams({
                    serviceType: 'repatriation-money-movement',
        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Why choose us for your repatriation and money transfer needs
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-sm border border-border/20">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Get perspectives from CA, CPA, and FEMA experts - all via Settleline. Start with a 30-minute risk-free consultation.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about our repatriation services
              </p>
            </div>
      ...
      {/* Footer CTA */}
      <FooterCTA
        title="Ready to Move Your Money Safely?"
